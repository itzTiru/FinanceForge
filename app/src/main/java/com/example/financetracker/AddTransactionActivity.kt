...
class AddTransactionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val transactionTypeText: TextView = findViewById(R.id.transaction_type_text)
        ...
        // Get the transaction type from the Intent
        val transactionType = intent.getStringExtra("TRANSACTION_TYPE") ?: "expense"
        transactionTypeText.text = "Type: ${transactionType.capitalize()}"

        // Set up the category dropdown
        val categories = listOf("Food", "Transport", "Entertainment", "Bills", "Salary", "Other")
